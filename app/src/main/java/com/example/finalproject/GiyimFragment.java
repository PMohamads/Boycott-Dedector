...
public class GiyimFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_giyim, container, false);
        linearLayout = view.findViewById(R.id.linear_giyim_layout);
        getir();
        return view;
    }
    ...
    public void getir() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference("hepsi").child("giyim");
        storageReference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                for (StorageReference prefix : listResult.getPrefixes()) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("items").child("giyim").child(subdirectoryName);
