...
public class icecekFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_icecek, container, false);
        linearLayout = view.findViewById(R.id.linear_icecek_layout);
    ...
    public void getir() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference("hepsi").child("icecek");
        storageReference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                for (StorageReference prefix : listResult.getPrefixes()) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("items").child("icecek").child(subdirectoryName);
