...
public class HepsiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hepsi, container, false);
        linearLayout = view.findViewById(R.id.linear_hepsi_layout);
        getir();
        return view;
    ...
    public void getir() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference("hepsi").child("hepsi");
        storageReference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                for (StorageReference prefix : listResult.getPrefixes()) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("items").child("hepsi").child(subdirectoryName);
