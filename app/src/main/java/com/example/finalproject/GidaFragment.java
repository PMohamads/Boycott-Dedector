...
public class GidaFragment extends Fragment {
    ...
    public void getir() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance().getReference("hepsi").child("gida");
        storageReference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                for (StorageReference prefix : listResult.getPrefixes()) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("items").child("gida").child(subdirectoryName);
