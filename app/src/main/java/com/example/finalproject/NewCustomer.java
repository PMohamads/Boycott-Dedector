...
public class NewCustomer extends AppCompatActivity {
    ...
    public void HesabEkle(View view) {
        ...
        if(GirilenSifre.length() >= 8){
            if (GirilenSifre.matches(".*[a-zA-Z].*") && GirilenSifre.matches(".*\\d.*")) {
                ...
                Toast.makeText(NewCustomer.this,"Hesabınız Başarlı Bir Şekilde Oluşturlmuştur ",Toast.LENGTH_LONG).show();
            }
            else {
    ...
    public void LoggingPage(View view) {
        startActivity(new Intent(NewCustomer.this,LogInPageActivity.class));
    }
}